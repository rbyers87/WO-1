...
export function WorkoutCard({ workout, onDelete }: WorkoutCardProps) {
  ...
  return (
    <div className="bg-white dark:bg-darkBackground rounded-lg shadow-md p-6 transition-all duration-300">
      <div className="flex justify-between items-start mb-4">
        <div>
          <h3 className="text-xl font-semibold dark:text-gray-100">{workout.name}</h3>
          {workout.description && (
            <p className="dark:text-gray-300 mt-1">{workout.description}</p>
          )}
        </div>
